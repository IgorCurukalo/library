# Generated by Django 4.1 on 2022-08-01 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_add', models.DateTimeField(auto_now_add=True, verbose_name='Дата добавления')),
                ('is_daleted', models.BooleanField(default=False, verbose_name='Удалено')),
                ('book_img', models.ImageField(blank=True, null=True, upload_to='books_image/%Y/%m/%d/', verbose_name='Ссылка на изображение')),
